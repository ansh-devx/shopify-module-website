      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="mt-4 text-lg text-gray-700">
            Authenticate with your Shopify Partner account to start using
            Shopify CLI:
          </p>
          ...
          <p className="mt-4 text-gray-700">
            This command will open a browser window where you can log in to your
        ...
        <section>
          ...
          <div className="mt-6 rounded-lg border border-blue-200 bg-blue-50 p-4">
            ...
            <p className="mt-2 text-sm text-blue-800">
              ...
              command starts a local development server that watches for changes
              in your theme files and automatically syncs them to your store.
            </p>
          </div>
        </section>

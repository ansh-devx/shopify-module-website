...
git push -u origin main`}
        ...
        <section>
          ...
          <p className="mt-4 text-lg text-gray-700">
            A command that starts a local development server for your Shopify
            theme, allowing you to develop and preview your theme in real-time
            without affecting your live store.
          </p>

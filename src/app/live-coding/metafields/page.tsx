      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="mt-4 text-lg text-gray-700">
            Metafields are custom data fields that let you store additional
            information beyond Shopify's default fields. They can be attached to
            products, variants, collections, customers, orders, and more.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-6">
              <h3 className="text-xl font-semibold text-gray-900">
                Step 2: Choose Resource Type
              </h3>
              <p className="mt-2 text-gray-700">Example: Product</p>
            </div>
        ...
        <section>
          <h2 className="text-3xl font-bold text-gray-900">
            Example: Creating "Material" Metafield
          </h2>
          ...
          <div className="mt-6 rounded-lg border border-gray-200 bg-gray-50 p-6">
            ...
            <ul className="mt-4 space-y-2 text-gray-700">
              <li>
                <strong>Name:</strong> Material
              </li>
              <li>
                <strong>Namespace:</strong> custom
              </li>
              <li>
                <strong>Key:</strong> material
              </li>
              <li>
          ...
          <div className="mt-6 rounded-lg border border-blue-200 bg-blue-50 p-4">
            ...
            <p className="mt-2 text-sm text-blue-800">
              This creates a metafield accessible as:{" "}
          ...
          <div className="mt-6 space-y-4">
            <div className="rounded-lg border border-gray-200 p-4">
              ...
              <p className="mt-2 text-sm text-gray-700">
                Short text values like material, SKU, or brand
              </p>
              <CodeBlock
            ...
            <div className="rounded-lg border border-gray-200 p-4">
              ...
              <p className="mt-2 text-sm text-gray-700">
                Longer text like care instructions or descriptions
              </p>
              <CodeBlock
            ...
            <div className="rounded-lg border border-gray-200 p-4">
              ...
              <p className="mt-2 text-sm text-gray-700">
                Numeric values like dimensions or ratings
              </p>
              <CodeBlock
            ...
            <div className="rounded-lg border border-gray-200 p-4">
              ...
              <p className="mt-2 text-sm text-gray-700">
                Boolean values for flags or toggles
              </p>
              <CodeBlock

...
export default function SnippetsPage() {
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="mt-4 text-lg text-gray-700">
            Snippets are reusable pieces of Liquid code that you can include in
            multiple places across your theme. They help you avoid code
            duplication and make your theme easier to maintain.
          </p>
        </section>
  ...
  <a href="{{ product.url }}">
    ...
    {% endif %}
        ...
        <section>
          ...
          <p className="mt-4 text-lg text-gray-700">
            You can include snippets in your theme using the{" "}
            <code className="rounded bg-gray-100 px-2 py-1 text-sm">
              render
            </code>{" "}
            tag.
  ...
  {% endfor %}
        ...
        <section>
          ...
          <p className="mt-4 text-lg text-gray-700">
            You can pass multiple variables to snippets to make them more
            flexible.
          </p>
